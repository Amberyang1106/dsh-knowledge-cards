			...
			handler: async (req, res) => {
				...
				try {
					...
					ok(res, { result: await createCard(kb, {
						type,
						title,
						description: body?.description !== void 0 ? asString(body.description).trim() || void 0 : void 0,
