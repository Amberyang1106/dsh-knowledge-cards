 ...
 */
import { registerKnowledgeRoutes } from "./host/routes.js";
...
export const KNOWLEDGE_CARDS_GUIDANCE = '本机已安装 dsh-knowledge-cards 插件（知识卡片，基于 Karpathy / llm_wiki 三层架构）：侧边栏「知识卡片」入口，中央列展示知识库面板（卡片墙 / 资料 / 代码 / 看板 / 审核 / 知识库管理）；宿主经 /api/dsh-knowledge/* 路由读写本地知识库（配置与缓存默认在 ~/.dsh/knowledge-cards）。' +
