...
import { addReview, listCards, listReviews, readCard, resolveLinkTargets } from "./store.js";
...
export async function buildDeepAuditPromptForKb(kb) {
 ...
 */
export async function auditKb(kb) {
    const cards = await listCards(kb);
