	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"lineage.jevDone": "JEV 完成：{n} 条候选（{line} · key 来源 {keySource} · model {model} · {cards} 张卡 · {questions} 个问题 · {requests} 批请求，最大 {payload} 字符）",
		...
		const en = {
			...
			"lineage.jevDone": "JEV done: {n} candidates ({line} · key from {keySource} · model {model} · {cards} cards · {questions} questions · {requests} requests, max {payload} chars)",
