		...
		* (`field` uses the dedicated 5-section structured form below instead.) */
		...
		function LineagePanel({ kbId, onClose, onApplied }) {
			...
			const runAgent = async () => {
				setBusy("run");
				setError(null);
				setStatus(t(void 0, "lineage.running"));
				try {
					...
					setStatus(t(void 0, "lineage.runStarted", {
						child: String(data.childId ?? "").slice(0, 8),
					...
					setError(message.includes("llm-unavailable") ? t(void 0, "lineage.llmUnavailable") : message);
					setStatus(null);
				} finally {
					setBusy(null);
				}
			...
			(0, react.useEffect)(() => {
				api("/api/dsh-knowledge/lineage/llm-status").then((data) => setLlmInfo(data.subagentsAvailable ? t(void 0, "lineage.llmReady", { providers: (data.providerNames ?? []).join(", ") || "default" }) : t(void 0, "lineage.llmUnavailable"))).catch(() => setLlmInfo(null));
			}, []);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				...
				rows.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", { children: row.confidence }),
