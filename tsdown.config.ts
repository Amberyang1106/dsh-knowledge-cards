...
export default clientBundle('@amberyang1106/dsh-knowledge-cards', ['src/index.ts', 'src/host/store.ts', 'src/host/lint.ts', 'src/host/tools.ts', 'src/host/audit.ts', 'src/host/rules.ts', 'src/host/lineage.ts', 'src/host/jev.ts', 'src/core/frontmatter.ts', 'src/core/search.ts'], {
  libExternal: [
